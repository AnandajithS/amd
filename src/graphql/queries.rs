...
impl GraphQLClient {
    ...
    pub async fn update_life_status(&self,
        member_id: i32,
        lives: i32,
        recovery_streak: i32,
        is_probation: bool,
        last_reset_month: i32,
    ) -> anyhow::Result<crate::graphql::models::LifeStatus> {
        let query = r#"
        ...
        let status: crate::graphql::models::LifeStatus = serde_json::from_value(data.clone())?;
        Ok(status)
    }
}
